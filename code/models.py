...
def get_autoenc_model2(input_height=360,
    ...
    description = dict( Model_Type="CNN_encoder51200",
                        input_height=input_height,
                        input_width=input_width,
                        color=color,
                        output_height=op_height,
    ...
    # at this point the representation is (5, 10, 256) i.e. 12800-dimensional
...
def get_autoenc_model3(input_height=360,
                      input_width=480,
                      op_height=360,
                      op_width=480,
                      l2_lambda=0,
    ...
    description = dict( Model_Type="CNN_encoder-simple51200",
                        input_height=input_height,
                        input_width=input_width,
                        color=color,
                        output_height=op_height,
